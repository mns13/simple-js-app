	...
	let connectionString =  "mongodb+srv://root:salami4@cluster0-ymp3h.mongodb.net/JScourse?retryWrites=true&w=majority";
...
<body>
	<div class="container">
		<h1 class="display-4 text-center py-1">To-Do App ADS</h1>
...
<script src="/browser.js"></script>
	...
	app.post('/update-item', passwordProtected, function(req, res){
		let safeText = sanitizeHTML(req.body.text, {allowedTags: [], allowedAttributes: {}});
